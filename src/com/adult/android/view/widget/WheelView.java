...
import com.adult.android.view.widget.adapter.WheelViewAdapter;

/**
 * @ClassName: WheelView
 * @Description: Numeric wheel view.
 * @author 潘学坤
 * @date 2015年3月9日 上午10:28:49
 * 
 */
public class WheelView extends View {
	...
	/*
	 * int[] SHADOWS_COLORS = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA };
	 */
	...
	/**
	 * Left and right padding value PADDING越大，对话框的宽度越大
	 * */
	...
	private void drawItems(Canvas canvas) {
		...
		// 8 is the distance between text and Left Side
		canvas.translate(8, -top + scrollingOffset);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.bg_title_bar));
		// �����߿�
