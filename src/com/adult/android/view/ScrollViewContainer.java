 ...
 * @Description: 商品详情分页控件(包含两个ScrollView的容器)
 * @author 潘学坤
 * @date 2015年2月4日 下午2:23:05
 * 
 */
public class ScrollViewContainer extends RelativeLayout {

	private OnStateChangedListener onStateChangedListener;
	public static final String TAG = "ScrollViewContainer";
				...
				if (state == AUTO_UP) {
					...
					if (mMoveLen <= -mViewHeight) {
						...
						if (onStateChangedListener != null) {
							onStateChangedListener.onArrivedBottom();
						}
					}
					...
					if (mMoveLen >= 0) {
						...
						mCurrentViewIndex = 0;
						if (onStateChangedListener != null) {
							onStateChangedListener.onArrivedTop();
						}
					}
				} else {
					mTimer.cancel();
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			} else if (((ProductDetailsSecondView) bottomView).canPullDown()
