...
public class OrderModel2 {
	...
	public void getOrderList(String userId, String pageCount, String status,
		...
		InternetClient.get(url, null, NewOrderListResponse.class,
				new HttpResponseListener<NewOrderListResponse>() {
	...
	public void getOrderDetail(String orderId,
			final OnGetOrderDetailCompletedListener listener) {
		// 共通参数
		Map<String, String> maps = new HashMap<String, String>();
		maps.put(ServiceUrlConstants.APP_KEY, ServiceUrlConstants.APP_KEY_VALUE);
		maps.put(ServiceUrlConstants.VERSION, ServiceUrlConstants.VERSION_VALUE);
		...
		String url = CopUtils.buildGetUrl(maps,
				ServiceUrlConstants.getApiHost());
		InternetClient.get(url, null, NewOrderDetailResponse.class,
				new HttpResponseListener<NewOrderDetailResponse>() {
	...
	public void deleteOrder(String orderId,
			final OnDeleteOrderCompletedListener listener) {
		// 共通参数
	...
	/** 获取运费 */
	public void getLogisticsPrice(String province,
			final OnDeleteOrderCompletedListener listener) {
		// 共通参数
		Map<String, String> maps = new HashMap<String, String>();
		maps.put(ServiceUrlConstants.APP_KEY, ServiceUrlConstants.APP_KEY_VALUE);
	...
	/** 获取订单详情 */
	public void getOrderSkuList(String orderId,
			final OnGetOrderSkuListCompletedListener listener) {
		// 共通参数
		Map<String, String> maps = new HashMap<String, String>();
		maps.put(ServiceUrlConstants.APP_KEY, ServiceUrlConstants.APP_KEY_VALUE);
		maps.put(ServiceUrlConstants.VERSION, ServiceUrlConstants.VERSION_VALUE);
		...
		String url = CopUtils.buildGetUrl(maps,
				ServiceUrlConstants.getApiHost());
		InternetClient.get(url, null, OrderSkuListResponse.class,
				new HttpResponseListener<OrderSkuListResponse>() {
