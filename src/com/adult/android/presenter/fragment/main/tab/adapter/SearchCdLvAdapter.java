...
import com.adult.android.entity.BrandInfo;

/**
 * Created by huangchao on 8/10/2015.
 */
public class SearchCdLvAdapter extends BaseAdapter {

	private Context context;

	private List<BrandInfo> searchList;

	private Map<Integer, BrandInfo> cdidMap = null;

	public SearchCdLvAdapter(Context context, List<BrandInfo> searchList,
			Map<Integer, BrandInfo> cdidMap) {
		this.context = context;
		this.searchList = searchList;
		this.cdidMap = cdidMap;
	}
