	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.image = (ImageView) convertView
					.findViewById(R.id.item_order_list_img);
			holder.txtOrderNum = (TextView) convertView
					.findViewById(R.id.item_order_list_id);
			holder.txtOrderStatus = (TextView) convertView
					.findViewById(R.id.item_order_list_status);
			holder.txtCreatTime = (TextView) convertView
					.findViewById(R.id.item_order_list_time);
			holder.txtCount = (TextView) convertView
					.findViewById(R.id.item_order_list_count);
			holder.txtOrderAmount = (TextView) convertView
					.findViewById(R.id.item_order_list_amount);
			holder.txtPayway = (TextView) convertView
					.findViewById(R.id.item_order_list_pay_way);
			holder.btnPay = (Button) convertView
					.findViewById(R.id.item_order_list_btn_pay);
